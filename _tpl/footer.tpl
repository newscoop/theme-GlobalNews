            <footer id="footer">
                <div class="row">
                    <div id="about-us-block" class="col-lg-5 col-md-5">
                        ...
                        <p><small>{{#copyrightMessage#}} {{#powered#}}<a target="_blank" href="http://newscoop.sourcefabric.org/"><b>Newscoop</b></a>. {{#designed#}}<a target="_blank" href="http://www.sourcefabric.org/"><b>Sourcefabric</b></a>.</small></p>
                    </div>
